...
#---------------------------------------------------------------------------------
CFLAGS		=	-g -O3 -Wall --std=gnu99 -mcpu=cell $(MACHDEP) $(INCLUDE) -maltivec
CXXFLAGS	=	$(CFLAGS)
...
#---------------------------------------------------------------------------------
LIBS		:=	-lSDL_mixer -lSDL_gfx -lSDL_ttf -lSDL -lpngdec -ljpgdec -lSDL_image -lSDLmain -ltiff -lpng -ljpeg -lSDL_ttf -lSDL_gfx -lvorbisfile -lvorbis -logg -laudio -lmikmod -lrsx -lgcm_sys -lsysutil -lsysmodule -lio -lfreetype -lcairo -lfreetype -lz -lpixman-1 -lrt -llv2 -lm
