...
extern void harddiskIdeDestroy(HarddiskIde* hd);

extern void harddiskIdeReset(HarddiskIde* hd);

UInt16 harddiskIdeRead(HarddiskIde* hd);
UInt16 harddiskIdePeek(HarddiskIde* hd);
extern void harddiskIdeWrite(HarddiskIde* hd, UInt16 value);

extern void harddiskIdeWriteRegister(HarddiskIde* hd, UInt8 reg, UInt8 value);
UInt8 harddiskIdeReadRegister(HarddiskIde* hd, UInt8 reg);
UInt8 harddiskIdePeekRegister(HarddiskIde* hd, UInt8 reg);

extern void harddiskIdeSaveState(HarddiskIde* hd);
extern void harddiskIdeLoadState(HarddiskIde* hd);
