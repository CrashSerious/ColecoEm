...
/*This is a hack since it doesn't appear to be in PS3 SDL, should be ok though since the scan codes likely didn't go this high*/
...
extern byte keyboard_buffer[16];
